      ...
      <div className="bg-slate-900 rounded-2xl p-6 text-white shadow-xl flex flex-wrap items-center justify-between gap-4 border border-slate-800">
        <div>
          <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-sky-400 mb-1">
            <ShieldCheck className="w-4 h-4 text-sky-400" /> Firebase Auth Custom Claims & RBAC
          </div>
        ...
        <div className="bg-slate-800 p-3 rounded-xl border border-slate-700 flex items-center gap-3">
          ...
          <div>
            ...
            <select
              ...
              className="bg-slate-900 border border-slate-600 rounded px-2.5 py-1 text-xs text-sky-400 font-extrabold focus:outline-none cursor-pointer"
            >
