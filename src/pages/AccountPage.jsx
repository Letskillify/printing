      ...
      <div className="min-h-screen bg-[#FAFBFD] font-sans text-[#0B1633] flex flex-col items-center justify-center p-6 text-center">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-6 py-3 rounded-2xl bg-[#FF5A1F] hover:bg-[#e44d15] text-white font-extrabold text-xs uppercase tracking-wider shadow-lg shadow-[#FF5A1F]/20 transition border-none cursor-pointer"
          >
            Sign In Now
          </button>
          <button
            onClick={() => setCurrentPage && setCurrentPage('signup')}
            className="px-6 py-3 rounded-2xl bg-white border border-slate-200 text-slate-800 font-extrabold text-xs hover:bg-slate-50 transition cursor-pointer"
          >
            Create Account
          </button>
        </div>
      ...
      <section className="bg-[#07152F] text-white py-12 sm:py-16 relative overflow-hidden border-b border-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            ...
            <button
              onClick={() => logout()}
              className="px-4 py-2.5 rounded-xl bg-white/10 hover:bg-red-600/20 hover:border-red-500/40 text-slate-200 hover:text-red-300 font-extrabold text-xs flex items-center gap-2 border border-slate-700 transition cursor-pointer"
            >
          ...
          <div className="lg:col-span-3 space-y-2">
            <div className="bg-white p-3 rounded-2xl border border-slate-200/90 shadow-xs space-y-1">
              <button
                ...
                className={`w-full p-3 rounded-xl text-left text-xs font-bold transition flex items-center justify-between cursor-pointer border-none ${
                  activeTab === 'orders'
              ...
              <button
                ...
                className={`w-full p-3 rounded-xl text-left text-xs font-bold transition flex items-center gap-2.5 cursor-pointer border-none ${
                  activeTab === 'profile'
                    ? 'bg-[#FF5A1F] text-white shadow-md shadow-[#FF5A1F]/20'
                    : 'bg-transparent text-slate-700 hover:bg-slate-100'
                }`}
            ...
            <div className="bg-gradient-to-br from-slate-900 to-indigo-950 p-5 rounded-2xl text-white space-y-2 border border-slate-800 shadow-xs">
              ...
              <h4 className="font-extrabold text-xs">Printigly Dedicated Support</h4>
            ...
            {activeTab === 'orders' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-slate-500 font-medium">Real-time sync with Firebase Firestore</span>
                </div>

                {loadingOrders ? (
                  <div className="bg-white p-12 rounded-3xl border border-slate-200 text-center text-slate-500 text-xs font-bold">
                  ...
                  <div className="bg-white p-12 rounded-3xl border border-slate-200 text-center space-y-3">
                    ...
                    <button
                      ...
                      className="px-6 py-2.5 rounded-xl bg-[#FF5A1F] text-white font-extrabold text-xs hover:bg-[#e44d15] cursor-pointer border-none shadow-md shadow-[#FF5A1F]/20"
                    >
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 font-medium">Select or add shipping addresses for instant 1-click checkout</p>
                  </div>
                  <button
                    onClick={() => openAddressModal()}
                    className="px-4 py-2.5 rounded-2xl bg-[#FF5A1F] hover:bg-[#e44d15] text-white font-extrabold text-xs flex items-center gap-2 shadow-md shadow-[#FF5A1F]/20 cursor-pointer border-none"
                  >
                ...
                {(!userProfile?.addresses || userProfile.addresses.length === 0) ? (
                  <div className="bg-white p-12 rounded-3xl border border-slate-200 text-center space-y-3">
                    ...
                    <button
                      onClick={() => openAddressModal()}
                      className="px-5 py-2 rounded-xl bg-blue-600 text-white font-extrabold text-xs hover:bg-blue-700 cursor-pointer border-none"
                    >
                      + Add First Address
                    </button>
                  </div>
                        ...
                        <div className="pt-4 border-t border-slate-100 flex items-center justify-between mt-4">
                          {!addr.isDefault ? (
                            <button
                              ...
                              className="text-[11px] font-extrabold text-blue-600 hover:text-blue-800 border-none bg-transparent cursor-pointer"
                            >
                              Set as Default
                            </button>
                          ) : (
                            <span className="text-[11px] font-bold text-emerald-600">✓ Active Default</span>
                          )}
              ...
              <div className="bg-white p-6 rounded-3xl border border-slate-200/90 shadow-xs space-y-6">
                <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 font-medium">Manage your personal contact info and B2B GST details for tax invoices</p>
                  </div>
                  <button
                    onClick={() => setIsEditingProfile(!isEditingProfile)}
                    className="px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-extrabold text-xs flex items-center gap-1.5 border-none cursor-pointer"
                  >
                ...
                {isEditingProfile ? (
                  <form onSubmit={handleProfileSubmit} className="space-y-4 text-xs">
                    ...
                    <div className="flex items-center gap-3 pt-2">
                      <button
                        type="submit"
                        className="px-6 py-2.5 rounded-xl bg-[#FF5A1F] hover:bg-[#e44d15] text-white font-extrabold text-xs shadow-md shadow-[#FF5A1F]/20 cursor-pointer border-none"
                      >
                      ...
                      <button
                        ...
                        className="px-4 py-2.5 rounded-xl bg-slate-100 text-slate-600 font-bold text-xs hover:bg-slate-200 cursor-pointer border-none"
                      >
                        Cancel
                      </button>
                    </div>
      ...
      {isAddressModalOpen && (
        <div className="fixed inset-0 z-50 bg-slate-950/75 backdrop-blur-xs flex items-center justify-center p-4">
          <form
            ...
            className="bg-white rounded-3xl w-full max-w-lg p-6 space-y-4 shadow-2xl border border-slate-200 animate-in fade-in duration-200 text-xs"
          >
