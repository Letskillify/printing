      ...
      <div className="max-w-3xl mx-auto px-4 py-12 space-y-6">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-[#E7EAF0] shadow-sm space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-6 border-b border-slate-100">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="px-3 py-1 rounded-xl bg-blue-50 text-blue-700 font-extrabold text-xs border border-blue-200">
                ...
                {order.items.map((item, idx) => (
                  <div key={idx} className="py-3 flex items-center justify-between text-xs">
                    <div>
                      ...
                      <span className="text-slate-400 text-[11px] font-medium">Quantity: {item.quantity} units</span>
                    </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
          <button
            ...
            className="w-full sm:w-auto px-7 py-4 rounded-2xl bg-[#FF5A1F] hover:bg-[#e44d15] text-white font-extrabold text-xs uppercase tracking-wider shadow-lg shadow-[#FF5A1F]/20 flex items-center justify-center gap-2 cursor-pointer transition border-none"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-7 py-4 rounded-2xl bg-[#07152F] hover:bg-slate-800 text-white font-extrabold text-xs uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer transition border-none"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-7 py-4 rounded-2xl bg-white border border-slate-300 text-slate-700 hover:bg-slate-50 font-extrabold text-xs uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer transition"
          >
